namespace PokeGoTrade.Migrations.PokeGoTradeMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PokeGoTradeModel.Models.PGTContext>
    {
        ...
        protected override void Seed(PokeGoTradeModel.Models.PGTContext context)
        {
            ...
            //    new Country { CountryId = 2, CountryName = "South Korea" }
            //};
            ...
            //{
            //    new City { CityId = 1, CityName = "Vancouver", CountryId = country.Single(x => x.CountryName == "Canada").CountryId },
            //    new City { CityId = 2, CityName = "Toronto", CountryId = country.Single(x => x.CountryName == "Canada").CountryId },
            //    new City { CityId = 3, CityName = "Seoul", CountryId = country.Single(x => x.CountryName == "South Korea").CountryId },
            //    new City { CityId = 4, CityName = "Daejeon", CountryId = country.Single(x => x.CountryName == "South Korea").CountryId },
            //};

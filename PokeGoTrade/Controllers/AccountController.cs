...
namespace PokeGoTrade.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    //return a user with this username and password.
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, PokeGoTrade.Models.ApplicationDbContext context)
        {
            var response = HttpContext.Request.Form["g-recaptcha-response"];
            string secretKey = "6LenRwcUAAAAAGZIeF8jX8HdCwiIuWX_TvXrN8ow";
            ...
            if (!verificationResult.Success)
            {
                ...
                switch (error)
                {
                    ...
                    case ("missing-input-response"):
                        TempData["CaptchaMessage"] = "The captcha input is missing";
                        break;
                    case ("invalid-input-response"):
                        TempData["CaptchaMessage"] = "The captcha input is invalid or malformed";
                        break;
                    default:
            ...
            else
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        //if a role for "User" doesn't exist, create one.
                        ...
                        //give a role "User" to the currently registered user.
                        ...
                        TempData["CaptchaMessage"] = "Registered Successfully";
                        return RedirectToAction("Login", "Account");
                    }
                    string errorMessage = String.Join(",", result.Errors);
                    TempData["CaptchaMessage"] = errorMessage;
                    AddErrors(result);
                }
            }
